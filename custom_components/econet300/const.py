...
# =============================================================================
# OPTIONS FLOW - CATEGORY CONFIGURATION
# =============================================================================
# Category mode options for Options Flow UI
CONF_CATEGORY_MODE = "category_mode"
CONF_CUSTOM_CATEGORIES = "custom_categories"

# Category mode values
CATEGORY_MODE_SIMPLIFIED = "simplified"
CATEGORY_MODE_API = "api"
CATEGORY_MODE_NONE = "none"

# Default category mode
DEFAULT_CATEGORY_MODE = CATEGORY_MODE_SIMPLIFIED

# Simplified category names
CATEGORY_BOILER = "Boiler settings"
CATEGORY_HUW = "HUW settings"
CATEGORY_MIXER = "Mixer settings"
CATEGORY_OTHER = "Other"

# All simplified categories (for UI dropdown)
SIMPLIFIED_CATEGORY_LIST = [
    CATEGORY_BOILER,
    CATEGORY_HUW,
    CATEGORY_MIXER,
    CATEGORY_OTHER,
...
# Keywords for automatic category assignment (simplified mode)
# Parameter name/description containing these keywords -> assigned to category
SIMPLIFIED_CATEGORY_KEYWORDS: dict[str, list[str]] = {
    CATEGORY_BOILER: [
        "boiler",
        "co temp",
        "co pump",
    ...
    # CATEGORY_OTHER has no keywords - it's the fallback
}
